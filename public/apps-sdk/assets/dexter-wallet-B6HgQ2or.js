...
function WalletHome({ payload, walletToken, onOpenExternal }) {
  ...
  if (sheet === "activity") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dxw-widget dxw-widget--sheet", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActivitySheet, { items: activity, onClose: closeSheet }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dxw-widget", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CompositionBar,
      {
        ...
        onOpen: money?.hasCreditLine ? () => openSheet("credit", "composition") : void 0,
        triggerRef: (element) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dxw-actions", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          onClick: money?.hasCreditLine ? () => openSheet("credit", "credit") : void 0,
