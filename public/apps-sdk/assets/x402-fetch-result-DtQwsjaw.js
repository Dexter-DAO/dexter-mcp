import { r as reactExports, j as jsxRuntimeExports, e as useAdaptiveSendFollowUp, u as useToolOutput, f as useAdaptiveOpenExternal, g as useAdaptiveTheme, c as captureWidgetException } from "./adapter-B3ynKBmf.js";
import { u as useDisplayMode, a as useRequestDisplayMode } from "./use-request-display-mode-C6w9QsYv.js";
...
function SessionFunding({
  ...
  const [continuing, setContinuing] = reactExports.useState(false);
  const [continueError, setContinueError] = reactExports.useState(null);
  const handleContinue = async () => {
    ...
    try {
      await sendFollowUp(
        `I funded the wallet. Re-check ${retryCall.url} with ${retryCall.method || "GET"}, show me the current price and exact request, and ask for fresh approval before any payment.`
      );
    ...
    canRetry && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dx-receipt-funding__retry", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: continuing ? "Opening chat…" : "I've funded it — continue in chat"
        }
      ),
      continueError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dx-receipt-funding__retry-error", role: "alert", children: continueError })
    ] }),
...
function PurchaseReceiptSummary({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dx-purchase-receipt__header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: receipt.modeLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: receipt.title })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("dl", { children: receipt.rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { children: row.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: row.value })
        ] }, `${row.label}:${row.value}`)) }),
        receipt.retryNote ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dx-purchase-receipt__retry", children: receipt.retryNote }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "dx-purchase-receipt__reference", children: [
          "Prepared purchase ",
          receipt.references.preparedId
        ] })
      ]
    }
  );
...
function settlementRows(receipt) {
  const settlement = isRecord(receipt.sellerSettlement) ? receipt.sellerSettlement : null;
...
function modeLabel(selectedMode) {
  switch (selectedMode) {
    case "direct_exact":
      return "Direct exact";
    case "native_tab":
...
function normalizePurchaseReceipt(value) {
  ...
  if (selectedMode === "native_tab") {
    ...
    const unconfirmed = voucherState === "unconfirmed" || cashState === "unconfirmed";
    const rows = [
    ...
    return {
      ...base,
      title: accepted ? "Seller tab accepted" : unconfirmed ? "Seller tab outcome unconfirmed" : voucherState === "refused" ? "Seller tab refused" : "Seller tab not issued",
  ...
  if (selectedMode === "gateway_cash") {
    ...
    const uncertain = buyerState === "charge_unconfirmed" || settlement.state === "unconfirmed";
    return {
      ...base,
      title: settlement.settled ? "Seller paid through Gateway cash" : uncertain ? "Gateway cash outcome unconfirmed" : "Gateway cash not completed",
  ...
  if (selectedMode === "gateway_credit") {
    ...
    const uncertain = exposureState === "unconfirmed" || obligationState === "unconfirmed" || settlement.state === "unconfirmed";
    const rows = [
    ...
    return {
      ...base,
      title: settlement.settled && obligationState === "finalized" ? "Seller paid; credit obligation finalized" : uncertain ? "Gateway credit outcome unconfirmed" : "Gateway credit not completed",
      tone: settlement.settled && obligationState === "finalized" ? "success" : uncertain ? "warning" : "neutral",
      sellerSettled: settlement.settled,
      rows
    };
  }
  return {
    ...base,
    title: settlement.settled ? "Seller paid directly" : settlement.state === "unconfirmed" ? "Direct settlement unconfirmed" : "Direct payment not sent",
    tone: settlement.settled ? "success" : settlement.state === "unconfirmed" ? "warning" : "neutral",
    sellerSettled: settlement.settled,
...
function FetchResult() {
  ...
  const isError = !isSession && (Boolean(toolOutput.error) || typeof toolOutput.mode === "string" && FAILURE_MODES.has(toolOutput.mode));
  ...
  const stamp = (() => {
    if (purchaseReceipt && (purchaseReceipt.mode !== "direct_exact" || !purchaseReceipt.sellerSettled)) {
      return null;
    }
    ...
    "div",
    {
      ...
      children: [
        isSession ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          purchaseReceipt ? /* @__PURE__ */ jsxRuntimeExports.jsx(PurchaseReceiptSummary, { receipt: purchaseReceipt }) : null,
          !isError && (stamp ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReceiptStamp, { data: stamp, onOpen: openExternal }) : accessProof ? /* @__PURE__ */ jsxRuntimeExports.jsx(AccessProof, { data: accessProof }) : null),
          !isError && topRec && /* @__PURE__ */ jsxRuntimeExports.jsx(
            InstinctNextCall,
            {
