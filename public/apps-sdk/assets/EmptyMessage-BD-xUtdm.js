import { r as reactExports, j as jsxRuntimeExports, s as commonjsGlobal, R as React } from "./adapter-BBMYb_B0.js";
import { c as canUseDOM, h as hasDocument, i as isTest, a as isDev } from "./AppsSDKUIContext-C9_wA7ac.js";
function r(e) {
  var t, f, n = "";
...
const Badge = ({ children, className, variant = "soft", color = "secondary", size = "sm", pill, ...restMaybeAsChildProps }) => {
  return jsxRuntimeExports.jsx("div", { className: clsx(s$4.Badge, className), "data-color": color, "data-size": size, "data-pill": pill ? "" : void 0, "data-variant": variant, ...restMaybeAsChildProps, children: wrapTextNodeSiblings(children) });
};
...
const LoadingIndicator = ({ className, size, strokeWidth, style, ...restProps }) => {
  return jsxRuntimeExports.jsx("div", { ...restProps, className: clsx(s$3.LoadingIndicator, className), style: style || toCssVariables({
    "indicator-size": size,
...
const Button = (props) => {
  ...
  return jsxRuntimeExports.jsxs("button", {
    type,
    className: clsx(s$1.Button, className),
    "data-color": color,
    ...
    onClick: handleClick,
    ...restProps,
    children: [jsxRuntimeExports.jsx(TransitionGroup, { className: s$1.ButtonLoader, enterDuration: 250, exitDuration: 150, children: loading && jsxRuntimeExports.jsx(LoadingIndicator, {}, "loader") }), jsxRuntimeExports.jsx("span", { className: s$1.ButtonInner, children: wrapTextNodeSiblings(children) })]
  });
};
