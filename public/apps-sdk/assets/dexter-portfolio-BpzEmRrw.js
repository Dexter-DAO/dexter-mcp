import { u as useToolOutput, a as useAdaptiveTheme, b as useAdaptiveMaxHeight, r as reactExports, j as jsxRuntimeExports } from "./adapter-BD2Wya3l.js";
/* empty css             */
...
function ReadyLedger({ model }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "dxp-ledger", "aria-labelledby": "dxp-title", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "dxp-hero", "aria-label": "Portfolio summary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { id: "dxp-title", children: "Portfolio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "strong",
        {
          className: summary.value === null ? "dxp-unknown" : void 0,
          "aria-label": summary.label,
          children: summary.value ?? "Unknown"
        }
      ),
      summary.label === "Priced subtotal" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Priced subtotal." }) : null,
...
function LoadingLedger() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "dxp-ledger dxp-ledger--loading", "aria-busy": "true", "aria-label": "Loading portfolio", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "dxp-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WalletLockup, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "dxp-hero", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Portfolio" }),
...
function StateLedger({ model }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "dxp-ledger dxp-ledger--state", "aria-labelledby": "dxp-state-title", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "dxp-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WalletLockup, {}) }),
...
function PortfolioLedger() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "dxp-root",
      ref: rootRef,
      style: maxHeight === null ? void 0 : { maxHeight },
      children: [
        model.state === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingLedger, {}) : null,
        model.state === "ready" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReadyLedger, { model }) : null,
        model.state !== "loading" && model.state !== "ready" ? /* @__PURE__ */ jsxRuntimeExports.jsx(StateLedger, { model }) : null
      ]
    }
  );
}
