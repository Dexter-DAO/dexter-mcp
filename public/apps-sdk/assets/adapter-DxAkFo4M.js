...
function useToolOutput() {
  return reactExports.useSyncExternalStore(
    subscribeAdaptive,
    () => _mcpToolOutput ?? chatGptGlobal("toolOutput") ?? null,
    () => null
  );
}
function useToolResponseMetadata() {
  return reactExports.useSyncExternalStore(
    subscribeAdaptive,
    () => _mcpToolMeta ?? chatGptGlobal("toolResponseMetadata") ?? null,
    () => null
  );
}
function useToolInput() {
  return reactExports.useSyncExternalStore(
    subscribeAdaptive,
    () => _mcpToolInput ?? chatGptGlobal("toolInput") ?? null,
    () => null
  );
}
...
export {
  ...
  useToolInput as q,
  reactExports as r,
  addWidgetBreadcrumb as s,
  captureWidgetException as t,
  useToolOutput as u,
  commonjsGlobal as v
};
