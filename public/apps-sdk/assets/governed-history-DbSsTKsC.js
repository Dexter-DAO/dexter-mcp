import { u as useToolOutput, g as useToolResponseMetadata, a as useAdaptiveTheme, c as useAdaptiveDisplayMode, e as useAdaptiveHostCapabilities, f as useAdaptiveRequestDisplayMode, h as useAdaptiveOpenExternal, r as reactExports, j as jsxRuntimeExports } from "./adapter-CnqTmm6v.js";
/* empty css             */
import { n as normalizeGovernedHistory, W as WidgetShell, G as GovernedActionDetail, a as WidgetError, b as WidgetEmpty } from "./GovernedActionView-DOsS4FLt.js";
import { c as clientExports } from "./client-CHHxyzum.js";
import { u as useIntrinsicHeight } from "./useIntrinsicHeight-CL7LgLGI.js";
import "./use-openai-global-Do_3DceD.js";
...
function HistoryLoading({ rootRef }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WidgetShell, { width: "full", rootRef, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dx-history dx-history--loading", role: "status", "aria-live": "polite", "aria-label": "Loading wallet history", children: [
...
function GovernedHistoryView() {
  ...
  if (renderOutput === null) return /* @__PURE__ */ jsxRuntimeExports.jsx(HistoryLoading, { rootRef });
  const selected = model && selectedIndex !== null ? model.items[selectedIndex] ?? null : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WidgetShell, { width: "full", rootRef, children: selected ? /* @__PURE__ */ jsxRuntimeExports.jsx(
