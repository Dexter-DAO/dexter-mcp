...
function useAdaptiveRequestDisplayMode() {
  ...
  const request = reactExports.useCallback(async ({ mode }) => {
    if (HOST === "mcp-apps") {
      return requestDisplayMode(mode);
    }
...
export {
  ...
  useToolResponseMetadata as c,
  useAdaptiveOpenExternal as d,
  openLinkProbe as e,
  requireReact as f,
  addWidgetBreadcrumb as g,
  captureWidgetException as h,
  useToolInput as i,
  jsxRuntimeExports as j,
  useAdaptiveHostContext as k,
  useAdaptiveHostCapabilities as l,
  useAdaptiveDisplayMode as m,
  useAdaptiveRequestDisplayMode as n,
  openLink as o,
  useAdaptiveUpdateModelContext as p,
  useAdaptiveSendFollowUp as q,
  reactExports as r,
  useAdaptiveCallToolFn as s,
  commonjsGlobal as t,
  useToolOutput as u
};
