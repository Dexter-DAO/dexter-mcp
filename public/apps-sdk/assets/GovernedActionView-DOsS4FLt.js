import { j as jsxRuntimeExports, u as useToolOutput, g as useToolResponseMetadata, a as useAdaptiveTheme, c as useAdaptiveDisplayMode, e as useAdaptiveHostCapabilities, f as useAdaptiveRequestDisplayMode, h as useAdaptiveOpenExternal, r as reactExports } from "./adapter-CnqTmm6v.js";
...
function GovernedLoading({ rootRef }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WidgetShell, { width: "full", rootRef, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dx-action dx-action--loading", role: "status", "aria-live": "polite", "aria-label": "Loading governed action", children: [
...
function GovernedActionView() {
  ...
  if (renderOutput === null) return /* @__PURE__ */ jsxRuntimeExports.jsx(GovernedLoading, { rootRef });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WidgetShell, { width: "full", rootRef, children: model ? /* @__PURE__ */ jsxRuntimeExports.jsx(
