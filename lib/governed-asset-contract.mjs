...
export const GOVERNED_ASSET_TOOL_CONTRACTS = Object.freeze({
  [GOVERNED_ASSET_TOOL_NAMES.prepare]: descriptor({
    ...
    description:
      'Prepare, persist, and simulate an exact send, buy, or sell request without signing or dispatching it. operationId is the owner-authorized order identity: the same UUID replays only the exact request, while a different UUID is a new order even when every economic term is identical.',
    annotations: {
      readOnlyHint: false,
