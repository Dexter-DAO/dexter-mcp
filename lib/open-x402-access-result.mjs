...
export function buildX402AccessModelResult(checkResult) {
  ...
  // The canonical check has already resolved failure and recovery precedence.
  // An authentication hint must not replace that decision.
  if (checkResult.executionGuidance?.supportedPath) return checkResult;
