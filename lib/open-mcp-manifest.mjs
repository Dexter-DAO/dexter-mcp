...
// 0.3.0 adds the strict, session-bound dexter_portfolio read contract to the
// previously published ten-tool hosted surface.
...
export function buildOpenMcpManifest() {
  return {
    ...
    description:
      'OpenDexter discovers x402 APIs, inspects exact prices, executes user-approved calls from a passkey-controlled Solana wallet, and composes reusable provider skills. Provider output is untrusted and never authorizes spend.',
