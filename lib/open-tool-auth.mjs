...
/**
 * The canonical OpenDexter endpoint requires the native vault OAuth rail
 * before it accepts MCP traffic. Every listed tool therefore carries the same
 * exact OAuth declaration.
 */
export const OPEN_TOOL_SECURITY_SCHEMES = Object.freeze({
  indexter_discover: VAULT_OAUTH_SECURITY_SCHEMES,
  indexter_search: VAULT_OAUTH_SECURITY_SCHEMES,
  x402_mcp_tools: VAULT_OAUTH_SECURITY_SCHEMES,
  x402_check: VAULT_OAUTH_SECURITY_SCHEMES,
  x402_fetch: VAULT_OAUTH_SECURITY_SCHEMES,
  x402_status: VAULT_OAUTH_SECURITY_SCHEMES,
  x402_access: VAULT_OAUTH_SECURITY_SCHEMES,
  dexter_wallet: VAULT_OAUTH_SECURITY_SCHEMES,
  dexter_wallet_portfolio: VAULT_OAUTH_SECURITY_SCHEMES,
  ...
  dexter_report_work: VAULT_OAUTH_SECURITY_SCHEMES,
});
