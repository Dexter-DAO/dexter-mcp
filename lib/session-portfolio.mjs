 ...
 *
 * Names, symbols, issuers, URLs, registry labels, token-extension strings,
 * price-source labels, and capability reasons are deliberately excluded.
 * What remains is chain identity, exact quantities, bounded numeric valuation,
 * and the action allowlist produced by the first-party portfolio policy.
 */
