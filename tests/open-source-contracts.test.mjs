...
test('cross-repository source verifier rejects every identity and byte attack', async (t) => {
  const cases = [
    ...
    ...[
      ...
      'src/portfolio/governedWrites/ownerCurrencySwapAsset.ts',
      'src/portfolio/governedWrites/ownerCurrencySwapContract.ts',
      'src/portfolio/governedWrites/ownerCurrencySwapFee.ts',
      'src/portfolio/governedWrites/ownerCurrencySwapPrepare.ts',
      'src/portfolio/governedWrites/ownerCurrencySwapQuote.ts',
      'src/portfolio/governedWrites/ownerCurrencySwapRoute.ts',
      'src/portfolio/governedWrites/ownerCurrencySwapRuntime.ts',
      'src/portfolio/governedWrites/ownerCurrencySwapSolana.ts',
      'src/portfolio/governedWrites/ownerSettlementCurrency.ts',
      'src/portfolio/governedWrites/ledger.ts',
      'src/portfolio/governedWrites/userPrepare.ts',
      'src/portfolio/governedWrites/userPrepareTypes.ts',
      'src/portfolio/governedWrites/ownerNativeSolIdentity.ts',
      'src/portfolio/governedWrites/governedTradingFee.ts',
      'src/portfolio/governedWrites/governedTradingFeeConfig.ts',
      'src/portfolio/governedWrites/jupiterServiceFee.ts',
      'src/portfolio/governedWrites/jupiterServiceFeeIdl.json',
      'src/portfolio/governedWrites/ownerSwapFeeContract.ts',
      'src/portfolio/governedWrites/ownerTokenLookupPreparation.ts',
      'src/portfolio/governedWrites/ownerTokenSwapLookupRoster.ts',
      'src/portfolio/governedWrites/ownerTradeFeeMessageContext.ts',
      'src/portfolio/governedWrites/ownerTradingFee.ts',
      'src/portfolio/governedWrites/ownerTradingFeeObservation.ts',
      'src/portfolio/governedWrites/solanaSwapFeeCollection.ts',
      'src/portfolio/governedWrites/governedOperationCeremony.ts',
      'src/portfolio/governedWrites/governedTransactionHistory.ts',
      ...
      'src/portfolio/governedWrites/ownerSendFacilitatorResult.ts',
